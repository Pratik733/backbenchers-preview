                    ...
                    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div class="lg:w-1/3 md:w-1/2 w-full px-5">
                            ...
                            <nav class="list-none mb-10">
                                <li>
                                    <a class="text-gray-400" href='https://discord.gg/uubrUH8eRW'>Discord Server</a>
                                </li>
                                <li>
                                    <a class="text-gray-400" href='https://chat.whatsapp.com/Cf7QS5vT6lpB4eEaCzjLwF'>Whatsapp</a>
                                </li>
                                <li>
                                    <a class="text-gray-400" href='#'>Euphoria (Coming Soon) </a>
                                </li>
                                <li>
                                    <a class="text-gray-400" href='https://backbenchers-edtech.typeform.com/work-with-us'>Work with us</a>
                                </li>
                                <li>
                                    <a class="text-gray-400" href='https://www.instagram.com/backbenchersed.tech/'>Gamified Learning</a>
                                </li>
                                <li>
                                    <a class="text-gray-400" href='https://backbenchers-edtech.typeform.com/student-dvlp-pg'>Apply for Students Developer Program</a>
                                </li>
                            </nav>
                        </div>
                        <div class="lg:w-1/3 md:w-1/2 w-full px-5">
                            ...
                            <nav class="list-none mb-10">
                                <li>
                                    <a class="text-gray-400" href='https://drive.google.com/drive/folders/1eu7RkTDVTfNsWNs0ak3IDRP9-wnfewgf?usp=sharing'>Meme Cheatsheets</a>
                                </li>
                                <li>
                                    <a class="text-gray-400" href='https://drive.google.com/drive/folders/1NK86QICo0qYRvJ1TQe05p5r_8ESaWZHT?usp=sharing'>Interactive Classes</a>
                                </li>
                                <li>
