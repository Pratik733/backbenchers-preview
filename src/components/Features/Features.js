  ...
  return (
    <div className='container'>
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-autow2">
...
● EUREKA - EUPHORIAN Fests, Competitions, and Battlecups (Coming Soon)
...
● EUPHORIA Inventory and Drops (Coming Soon)
[Post closing ongoing talks with big brands regarding collaborations/sponsorships/tie
ups]Earn digital drops, with tiers ranging from common to ultra-rare at the end of
...
On successful completion of projects, students will be issued certificates
          ...
          <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 class="text-gray-900 text-lg title-font font-medium mb-2">The Catalyzer</h2>
              <p class="leading-relaxed text-base">Highly interactive COMMUNITY
...
rewards such as coupons/discount vouchers etc.</p>
          ...
          <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Shooting Stars</h2>
              <p class="leading-relaxed text-base">Alumni Network – The EUPHORIA Army
...
enough progress, a learner can become a mentor too, restarting the virtuous cycle.              </p>
              <a class="mt-3 text-yellow-500 inline-flex items-center">Learn More
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
