            ...
            <div className="demo ">
                <div class="demo-container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
                    <div class="demo-contents lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center">
                        <h1 class="title-font sm:text-4xl text-3xl  font-medium text-gray-400">Beta Testing Phase 2
                        </h1>
                        <p class=" leading-relaxed text-gray-200 w-4/5">We are back with our exclusive beta testing 2 along with  some exciting offers
                        ...
                        <div className="">
                            ...
                            <div className="py-5">
                                ...
                                <ul className="list-disc px-10 text-indigo-100">
                            ...
                            <div className="py-5">
                                <ul className="price-list ">
                                    <li className="text-white">For CODING<span className="subs-price text-red-400"> ₹99/Student</span></li>
